...
{
       0,    40,    40,    43,    43,    46,    49,    53,    56,    61,
      63,    66,    71,    72,    76,   113,   119,   120,   124,   132,
     139,   145,   150,   156,   161,   164
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATGREATAMPERSAND", "ERRTOOUT", "SEMICOLON", "SUBSHELL", "$accept",
  "goal", "commands", "command", "simple_command", "pipe_list",
  "command_and_args", "arg_list", "argument", "command_word",
  "iomodifier_list", "iomodifier_opt", "background_optional", YY_NULLPTR
};
#endif
...
{
       0,     1,     3,     6,    17,    18,    19,    20,    21,    22,
      25,     6,     0,    19,     8,    26,    23,    22,     5,     7,
       9,    10,    11,    12,    13,    27,    28,     3,    24,     3,
       3,     3,     3,     3,     6
};
